Project2: Enterprise Software Deployment Project

Overview:
This project demonstrates the implementation of a centralized software distribution system using Windows Server 2022
and Active Directory Group Policy Objects (GPOs). The primary goal was to automate the installation of Mozilla Firefox across domain-joined client machines to ensure 
software consistency and reduce manual administrative overhead.
